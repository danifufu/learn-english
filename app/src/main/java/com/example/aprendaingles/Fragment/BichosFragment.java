...
public class BichosFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCao = view.findViewById(R.id.img_btn_cao);
        btnGato = view.findViewById(R.id.img_btn_gato);
        btnLeao = view.findViewById(R.id.img_btn_leao);
        btnMacaco = view.findViewById(R.id.img_btn_macaco);
        btnOvelha = view.findViewById(R.id.img_btn_ovelha);
        btnVaca = view.findViewById(R.id.img_btn_vaca);

        // Aplicando evento de clique em todos os botoes
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_btn_cao:
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.dog);
                tocarSom();
                break;

            case R.id.img_btn_gato:
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.cat);
                tocarSom();
                break;

            case R.id.img_btn_leao:
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.lion);
                tocarSom();
                break;

            case R.id.img_btn_macaco:
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.monkey);
                tocarSom();
                break;

            case R.id.img_btn_ovelha:
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.sheep);
                tocarSom();
                break;

            case R.id.img_btn_vaca:
